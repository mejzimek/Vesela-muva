...
int main() {
    ...
    Shader blendingShader("resources/shaders/blend.vs", "resources/shaders/blend.fs");
    ...
    unsigned int bubbleTexture = loadTexture(FileSystem::getPath("resources/textures/baloncic.png").c_str());

    blendingShader.use();
    blendingShader.setInt("texture1", 0);

    vector<glm::vec3> bubblePos = {
    ...
    muvaModel.SetShaderTextureNamePrefix("material.");
    stbi_set_flip_vertically_on_load(true);

    //Model balonModel("resources/objects/balon/pumpkin.blend");
    //balonModel.SetShaderTextureNamePrefix("material.");
    ...
    dirLight.direction = glm::vec3(0.0, 0.0, 1.0);
